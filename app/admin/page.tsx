      ...
      <main className="min-h-screen bg-black text-white px-4 py-20">
        <div className="max-w-md mx-auto space-y-6">
          <div className="space-y-2 text-center">
            ...
            <p className="text-gray-400">Sign in to view purchase requests.</p>
          </div>
          <form className="rounded-3xl border border-gray-800 bg-gray-900/40 p-8 space-y-4" onSubmit={handleLogin}>
    ...
    <main className="min-h-screen bg-black text-white px-4 py-20">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-gray-400">Requests are stored in Supabase.</p>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <button
            type="button"
            onClick={loadRequests}
            className="rounded-full border border-gray-700 px-5 py-2 text-sm font-semibold text-gray-200 hover:bg-gray-900"
          >
            Refresh
          </button>
          <button
        ...
        {requests.length === 0 ? (
          <div className="rounded-3xl border border-gray-800 bg-gray-900/40 p-10 text-center text-gray-400">
              ...
              <div key={request.id} className="rounded-3xl border border-gray-800 bg-gray-900/40 p-6">
                ...
                <div className="mt-4 grid gap-3 text-sm text-gray-300">
                  ...
                  <div className="grid gap-1">
                    ...
                    <a className="underline decoration-gray-600" href={`mailto:${request.email}`}>
                      {request.email}
                    </a>
                  </div>
                  <div className="grid gap-1">
                    <span className="text-gray-500">Phone</span>
                    <a className="underline decoration-gray-600" href={`tel:${request.phone}`}>
                      {request.phone}
                    </a>
                  </div>
                  <div className="grid gap-1">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <a
                          className="rounded-full border border-gray-700 px-3 py-1 text-xs font-semibold text-gray-200 hover:bg-gray-900"
            ...
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="rounded-full border border-gray-700 px-4 py-2 text-sm font-semibold text-gray-200 hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Previous
                </button>
                <button
