  ...
  return (
    <section className={`aura-home-hero ${className || ""}`} id="home" aria-labelledby="hero-heading">
      <div className="aura-home-hero-inner">
        ...
        <div className="aura-home-product-stage" aria-label="Aura disposable vape">
          ...
          <div className="aura-home-product-image-wrap">
            <Image
              src="/images/cutouts/og.png"
              alt="Aura disposable vape"
              fill
              priority
